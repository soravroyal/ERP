...
:: Set EPRTR database parameters (-s: sever, -db: database name, -u: user, -p: password); optionally -z flag for compression
MakeConfiguration -s MATIKO -db EPRTRmaster -u sa -p saretex1
