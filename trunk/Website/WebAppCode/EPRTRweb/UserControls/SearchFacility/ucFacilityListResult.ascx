     ...
     <table>
       <thead>
        <tr class="generalListStyle_headerRow">
          <th><div id="headerFacility"> <asp:LinkButton ID="lnkFacility" Text="<%$ Resources:Facility,FacilityNameXXXX %>" CommandName="Sort" CommandArgument="FacilityName" runat="server"></asp:LinkButton>     <asp:Image ID="upFacility" runat="server" ImageUrl="~/images/arrow_up.gif" Visible="true"/>   <asp:Image ID="downFacility" runat="server" ImageUrl="~/images/arrow_down.gif" Visible="false"/>   </div></th>
