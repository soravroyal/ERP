...
public partial class ucFacilityListSheetEPER : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (this.ucFacilityListResultEPER.ContentChanged == null)
            this.ucFacilityListResultEPER.ContentChanged = new EventHandler(contentChanged);
    }
    ...
    {
        this.ucFacilityListResultEPER.Visible = false;
    ...
    public void DoSaveCSV(object sender, EventArgs e)
    {
        switch (Sheet)
        {
            case Sheets.FacilitySearch.Facilities:
                this.ucFacilityListResultEPER.DoSaveCSV(this, EventArgs.Empty);
                break;
            default:
                break;
        }
