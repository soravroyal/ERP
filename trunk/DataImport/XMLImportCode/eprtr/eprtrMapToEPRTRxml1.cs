...
using EPRTRxml1; // application.libraries
...

{
	...
	public class eprtrMapToEPRTRxml1 : Altova.TraceProvider 
	{
		...
		public void Run(String PollutantReleaseAndTransferReport2SourceFilename, string EPRTRxml1TargetConnectionString)
		{
		// open source streams
		...
		// run
		Run(PollutantReleaseAndTransferReport2Source, EPRTRxml1TargetConnectionString);

		// close source streams
		PollutantReleaseAndTransferReport2Source.Stream.Close();
	}

		public void Run(Altova.IO.Input PollutantReleaseAndTransferReport2Source, string EPRTRxml1TargetConnectionString)
		{
			...
			// Create the target
			WriteTrace("Connecting to EPRTRxml1 database...\n");
			System.Data.OleDb.OleDbConnection EPRTRxml1TargetObject = null;	
			try
			{		
				EPRTRxml1TargetObject = new System.Data.OleDb.OleDbConnection( EPRTRxml1TargetConnectionString );
				EPRTRxml1TargetObject.Open();
			}
			catch (Exception e)
			{
				throw new DataTargetUnavailableException("Error connecting to database.", e);
			}
			mTransactionHelper = new DbTreeOperations.TransactionHelper(EPRTRxml1TargetObject, "BEGIN TRANSACTION ", "COMMIT TRANSACTION ", "ROLLBACK TRANSACTION ", "SAVE TRANSACTION  %%TRANSACTION_NAME%% ", "ROLLBACK TRANSACTION  %%TRANSACTION_NAME%% ");

			// Execute mapping
			adddbo_PollutantReleaseAndTransferReport(m_PollutantReleaseAndTransferReport2Instance, EPRTRxml1TargetObject);

			// Close the target
			EPRTRxml1TargetObject.Close();
...
public void adddbo_PollutantReleaseAndTransferReport(XmlNode src_PollutantReleaseAndTransferReport, System.Data.IDbConnection tgt_EPRTRxml1)
{
	...
	Altova.Db.DbTreeOperations.RecordBuffer new_dbo_PollutantReleaseAndTransferReport = 
		Altova.Db.DbTreeOperations.AddElement(tgt_EPRTRxml1, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_altova_EPRTRxml1_altova_dbo_PollutantReleaseAndTransferReport]);
...
public void addReportingYear(XmlNode src_ReportingYear, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_PollutantReleaseAndTransferReport)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_PollutantReleaseAndTransferReport, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantReleaseAndTransferReport_altova_ReportingYear], Altova.CoreTypes.CastToInt64(m_var426_ReportingYear_integer_long));
}
...
{
	// Create "CountryID"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_PollutantReleaseAndTransferReport, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantReleaseAndTransferReport_altova_CountryID], Altova.CoreTypes.CastToString(m_var430_CountryID_string));
}
...
public void addCoordinateSystemID(XmlNode src_CoordinateSystemID, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_PollutantReleaseAndTransferReport)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_PollutantReleaseAndTransferReport, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantReleaseAndTransferReport_altova_CoordinateSystemID], Altova.CoreTypes.CastToString(m_var434_CoordinateSystemID_string));
}
...
{
	// Create "RemarkText"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_PollutantReleaseAndTransferReport, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantReleaseAndTransferReport_altova_RemarkText], Altova.CoreTypes.CastToString(m_var438_RemarkText_string));
}
...
public void adddbo_CompetentAuthorityParty_PollutantReleaseAndTransferReportID(XmlNode src_CompetentAuthorityParty, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_PollutantReleaseAndTransferReport)
{
	...
	Altova.Db.DbTreeOperations.RecordBuffer new_dbo_CompetentAuthorityParty_PollutantReleaseAndTransferReportID = 
		Altova.Db.DbTreeOperations.AddElement(tgt_dbo_PollutantReleaseAndTransferReport, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantReleaseAndTransferReport_altova_dbo_CompetentAuthorityParty_PollutantReleaseAndTransferReportID]);
	Altova.Db.DbTreeOperations.SetValue(new_dbo_CompetentAuthorityParty_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_CompetentAuthorityParty_altova_PollutantReleaseAndTransferReportID], Altova.Db.DbTreeOperations.FindAttribute(tgt_dbo_PollutantReleaseAndTransferReport, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantReleaseAndTransferReport_altova_PollutantReleaseAndTransferReportID]));
	bool bRowsAffected = false;
	bool bProcessChildren = true;
	bool bDeleteRow = false;
...
{
	// Create "Name"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_CompetentAuthorityParty_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_CompetentAuthorityParty_altova_Name], Altova.CoreTypes.CastToString(m_var444_Name_string));
}
...
public void addContactPersonName(XmlNode src_ContactPersonName, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_CompetentAuthorityParty_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_CompetentAuthorityParty_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_CompetentAuthorityParty_altova_ContactPersonName], Altova.CoreTypes.CastToString(m_var448_ContactPersonName_string));
}
...
public void addTelephoneCommunication(XmlNode src_CompleteNumberText, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_CompetentAuthorityParty_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_CompetentAuthorityParty_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_CompetentAuthorityParty_altova_TelephoneCommunication], Altova.CoreTypes.CastToString(m_var454_CompleteNumberText_string));
}
...
public void addFaxCommunication(XmlNode src_CompleteNumberText, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_CompetentAuthorityParty_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_CompetentAuthorityParty_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_CompetentAuthorityParty_altova_FaxCommunication], Altova.CoreTypes.CastToString(m_var460_CompleteNumberText_string));
}
...
public void addEmailCommunication(XmlNode src_EmailURIID, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_CompetentAuthorityParty_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_CompetentAuthorityParty_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_CompetentAuthorityParty_altova_EmailCommunication], Altova.CoreTypes.CastToString(m_var466_EmailURIID_string));
}
...
public void adddbo_Address_Competent_CompetentAuthorityPartyID(XmlNode src_Address, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_CompetentAuthorityParty_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.RecordBuffer new_dbo_Address_Competent_CompetentAuthorityPartyID = 
		Altova.Db.DbTreeOperations.AddElement(tgt_dbo_CompetentAuthorityParty_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_CompetentAuthorityParty_altova_dbo_Address_Competent_CompetentAuthorityPartyID]);
	Altova.Db.DbTreeOperations.SetValue(new_dbo_Address_Competent_CompetentAuthorityPartyID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_Competent_altova_CompetentAuthorityPartyID], Altova.Db.DbTreeOperations.FindAttribute(tgt_dbo_CompetentAuthorityParty_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_CompetentAuthorityParty_altova_CompetentAuthorityPartyID]));
	bool bRowsAffected = false;
	bool bProcessChildren = true;
	bool bDeleteRow = false;
...
{
	// Create "StreetName"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_Address_Competent_CompetentAuthorityPartyID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_Competent_altova_StreetName], Altova.CoreTypes.CastToString(m_var472_StreetName_string));
}
...
public void addBuildingNumber(XmlNode src_BuildingNumber, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_Address_Competent_CompetentAuthorityPartyID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_Address_Competent_CompetentAuthorityPartyID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_Competent_altova_BuildingNumber], Altova.CoreTypes.CastToString(m_var476_BuildingNumber_string));
}
...
{
	// Create "CityName"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_Address_Competent_CompetentAuthorityPartyID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_Competent_altova_CityName], Altova.CoreTypes.CastToString(m_var480_CityName_string));
}
...
{
	// Create "PostcodeCode"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_Address_Competent_CompetentAuthorityPartyID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_Competent_altova_PostcodeCode], Altova.CoreTypes.CastToString(m_var484_PostcodeCode_string));
}
...
{
	// Create "CountryID"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_Address_Competent_CompetentAuthorityPartyID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_Competent_altova_CountryID], Altova.CoreTypes.CastToString(m_var488_CountryID_string));
}
...
public void adddbo_FacilityReport_PollutantReleaseAndTransferReportID(XmlNode src_FacilityReport, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_PollutantReleaseAndTransferReport)
{
	...
	Altova.Db.DbTreeOperations.RecordBuffer new_dbo_FacilityReport_PollutantReleaseAndTransferReportID = 
		Altova.Db.DbTreeOperations.AddElement(tgt_dbo_PollutantReleaseAndTransferReport, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantReleaseAndTransferReport_altova_dbo_FacilityReport_PollutantReleaseAndTransferReportID]);
	Altova.Db.DbTreeOperations.SetValue(new_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_PollutantReleaseAndTransferReportID], Altova.Db.DbTreeOperations.FindAttribute(tgt_dbo_PollutantReleaseAndTransferReport, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantReleaseAndTransferReport_altova_PollutantReleaseAndTransferReportID]));
	bool bRowsAffected = false;
	bool bProcessChildren = true;
	bool bDeleteRow = false;
...
{
	// Create "NationalID"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_NationalID], Altova.CoreTypes.CastToString(m_var494_NationalID_string));
}
...
public void addParentCompanyName(XmlNode src_ParentCompanyName, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_ParentCompanyName], Altova.CoreTypes.CastToString(m_var498_ParentCompanyName_string));
}
...
{
	// Create "FacilityName"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_FacilityName], Altova.CoreTypes.CastToString(m_var502_FacilityName_string));
}
...
public void addRiverBasinDistrictID(XmlNode src_RiverBasinDistrictID, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_RiverBasinDistrictID], Altova.CoreTypes.CastToString(m_var506_RiverBasinDistrictID_string));
}
...
public void addNACEMainEconomicActivityCode(XmlNode src_NACEMainEconomicActivityCode, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_NACEMainEconomicActivityCode], Altova.CoreTypes.CastToString(m_var510_NACEMainEconomicActivityCode_string));
}
...
public void addMainEconomicActivityName(XmlNode src_MainEconomicActivityName, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_MainEconomicActivityName], Altova.CoreTypes.CastToString(m_var514_MainEconomicActivityName_string));
}
...
public void addCompetentAuthorityName(XmlNode src_CompetentAuthorityPartyName, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_CompetentAuthorityName], Altova.CoreTypes.CastToString(m_var518_CompetentAuthorityPartyName_string));
}
...
public void addTotalIPPCInstallationQuantity(XmlNode src_TotalIPPCInstallationQuantity, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_TotalIPPCInstallationQuantity], Altova.CoreTypes.CastToInt(m_var522_TotalIPPCInstallationQuantity_nonNegativeInteger_int));
}
...
public void addOperationHours(XmlNode src_OperationHours, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_OperationHours], Altova.CoreTypes.CastToInt(m_var526_OperationHours_nonNegativeInteger_int));
}
...
public void addTotalEmployeeQuantity(XmlNode src_TotalEmployeeQuantity, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_TotalEmployeeQuantity], Altova.CoreTypes.CastToInt(m_var530_TotalEmployeeQuantity_nonNegativeInteger_int));
}
...
{
	// Create "NutsRegionID"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_NutsRegionID], Altova.CoreTypes.CastToString(m_var534_NutsRegionID_string));
}
...
public void addPublicInformation(XmlNode src_PublicInformation, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_PublicInformation], Altova.CoreTypes.CastToString(m_var538_PublicInformation_string));
}
...
public void addConfidentialIndicator(XmlNode src_ConfidentialIndicator, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_ConfidentialIndicator], Altova.CoreTypes.CastToBool(m_var542_ConfidentialIndicator_boolean));
}
...
public void addConfidentialCode(XmlNode src_ConfidentialCode, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_ConfidentialCode], Altova.CoreTypes.CastToString(m_var546_ConfidentialCode_string));
}
...
public void addProtectVoluntaryData(XmlNode src_ProtectVoluntaryData, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_ProtectVoluntaryData], Altova.CoreTypes.CastToBool(m_var550_ProtectVoluntaryData_boolean));
}
...
{
	// Create "RemarkText"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_RemarkText], Altova.CoreTypes.CastToString(m_var554_RemarkText_string));
}
...
public void addPrevNationalID(XmlNode src_NationalID, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_PrevNationalID], Altova.CoreTypes.CastToString(m_var560_NationalID_string));
}
...
public void addPrevReportingYear(XmlNode src_ReportingYear, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_PrevReportingYear], Altova.CoreTypes.CastToInt64(m_var566_ReportingYear_integer_long));
}
...
public void addLongitudeMeasure(XmlNode src_LongitudeMeasure, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_LongitudeMeasure], Altova.CoreTypes.CastToDouble(m_var572_LongitudeMeasure_float_double));
}
...
public void addLatitudeMeasure(XmlNode src_LatitudeMeasure, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_LatitudeMeasure], Altova.CoreTypes.CastToDouble(m_var578_LatitudeMeasure_float_double));
}
...
{
	// Create "ProductName"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_ProductName], Altova.CoreTypes.CastToString(m_var584_ProductName_string));
}
...
{
	// Create "Quantity"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_Quantity], Altova.CoreTypes.CastToDouble(m_var590_Quantity_decimal_double));
}
...
public void addQuantityUnitCode(XmlNode src_unitCode, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_QuantityUnitCode], Altova.CoreTypes.CastToString(m_var599_unitCode_string));
}
...
public void addWebsiteCommunication(XmlNode src_WebsiteURIID, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_WebsiteCommunication], Altova.CoreTypes.CastToString(m_var605_WebsiteURIID_string));
}
...
public void adddbo_Activity_FacilityReportID(XmlNode src_Activity, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.RecordBuffer new_dbo_Activity_FacilityReportID = 
		Altova.Db.DbTreeOperations.AddElement(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_dbo_Activity_FacilityReportID]);
	Altova.Db.DbTreeOperations.SetValue(new_dbo_Activity_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Activity_altova_FacilityReportID], Altova.Db.DbTreeOperations.FindAttribute(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_FacilityReportID]));
	bool bRowsAffected = false;
	bool bProcessChildren = true;
	bool bDeleteRow = false;
...
public void addRankingNumeric(XmlNode src_RankingNumeric, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_Activity_FacilityReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_Activity_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Activity_altova_RankingNumeric], Altova.CoreTypes.CastToInt64(m_var611_RankingNumeric_positiveInteger_long));
}
...
public void addAnnexIActivityCode(XmlNode src_AnnexIActivityCode, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_Activity_FacilityReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_Activity_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Activity_altova_AnnexIActivityCode], Altova.CoreTypes.CastToString(m_var615_AnnexIActivityCode_string));
}
...
public void adddbo_Address_Facility_FacilityReportID(XmlNode src_Address, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.RecordBuffer new_dbo_Address_Facility_FacilityReportID = 
		Altova.Db.DbTreeOperations.AddElement(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_dbo_Address_Facility_FacilityReportID]);
	Altova.Db.DbTreeOperations.SetValue(new_dbo_Address_Facility_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_Facility_altova_FacilityReportID], Altova.Db.DbTreeOperations.FindAttribute(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_FacilityReportID]));
	bool bRowsAffected = false;
	bool bProcessChildren = true;
	bool bDeleteRow = false;
...
{
	// Create "StreetName"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_Address_Facility_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_Facility_altova_StreetName], Altova.CoreTypes.CastToString(m_var621_StreetName_string));
}
...
{
	// Create "BuildingNumber"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_Address_Facility_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_Facility_altova_BuildingNumber], Altova.CoreTypes.CastToString(m_var625_BuildingNumber_string));
}
...
{
	// Create "CityName"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_Address_Facility_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_Facility_altova_CityName], Altova.CoreTypes.CastToString(m_var629_CityName_string));
}
...
{
	// Create "PostcodeCode"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_Address_Facility_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_Facility_altova_PostcodeCode], Altova.CoreTypes.CastToString(m_var633_PostcodeCode_string));
}
...
{
	// Create "CountryID"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_Address_Facility_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_Facility_altova_CountryID], Altova.CoreTypes.CastToString(m_var637_CountryID_string));
}
...
public void adddbo_PollutantRelease_FacilityReportID(XmlNode src_PollutantRelease, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.RecordBuffer new_dbo_PollutantRelease_FacilityReportID = 
		Altova.Db.DbTreeOperations.AddElement(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_dbo_PollutantRelease_FacilityReportID]);
	Altova.Db.DbTreeOperations.SetValue(new_dbo_PollutantRelease_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantRelease_altova_FacilityReportID], Altova.Db.DbTreeOperations.FindAttribute(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_FacilityReportID]));
	bool bRowsAffected = false;
	bool bProcessChildren = true;
	bool bDeleteRow = false;
...
{
	// Create "MediumCode"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_PollutantRelease_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantRelease_altova_MediumCode], Altova.CoreTypes.CastToString(m_var643_MediumCode_string));
}
...
public void addPollutantCode(XmlNode src_PollutantCode, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_PollutantRelease_FacilityReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_PollutantRelease_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantRelease_altova_PollutantCode], Altova.CoreTypes.CastToString(m_var647_PollutantCode_string));
}
...
public void addMethodBasisCode(XmlNode src_MethodBasisCode, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_PollutantRelease_FacilityReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_PollutantRelease_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantRelease_altova_MethodBasisCode], Altova.CoreTypes.CastToString(m_var651_MethodBasisCode_string));
}
...
{
	// Create "ConfidentialIndicator"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_PollutantRelease_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantRelease_altova_ConfidentialIndicator], Altova.CoreTypes.CastToBool(m_var655_ConfidentialIndicator_boolean));
}
...
{
	// Create "ConfidentialCode"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_PollutantRelease_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantRelease_altova_ConfidentialCode], Altova.CoreTypes.CastToString(m_var659_ConfidentialCode_string));
}
...
{
	// Create "RemarkText"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_PollutantRelease_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantRelease_altova_RemarkText], Altova.CoreTypes.CastToString(m_var663_RemarkText_string));
}
...
public void addTotalQuantity(XmlNode src_TotalQuantity, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_PollutantRelease_FacilityReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_PollutantRelease_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantRelease_altova_TotalQuantity], Altova.CoreTypes.CastToDouble(m_var667_TotalQuantity_decimal_double));
}
...
public void addTotalQuantityUnitCode(XmlNode src_unitCode, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_PollutantRelease_FacilityReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_PollutantRelease_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantRelease_altova_TotalQuantityUnitCode], Altova.CoreTypes.CastToString(m_var674_unitCode_string));
}
...
public void addAccidentalQuantity(XmlNode src_AccidentalQuantity, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_PollutantRelease_FacilityReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_PollutantRelease_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantRelease_altova_AccidentalQuantity], Altova.CoreTypes.CastToDouble(m_var678_AccidentalQuantity_decimal_double));
}
...
public void addAccidentalQuantityUnitCode(XmlNode src_unitCode, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_PollutantRelease_FacilityReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_PollutantRelease_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantRelease_altova_AccidentalQuantityUnitCode], Altova.CoreTypes.CastToString(m_var685_unitCode_string));
}
...
public void adddbo_MethodUsed_PollutantRelease_PollutantReleaseID(XmlNode src_MethodUsed, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_PollutantRelease_FacilityReportID)
{
	...
	Altova.Db.DbTreeOperations.RecordBuffer new_dbo_MethodUsed_PollutantRelease_PollutantReleaseID = 
		Altova.Db.DbTreeOperations.AddElement(tgt_dbo_PollutantRelease_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantRelease_altova_dbo_MethodUsed_PollutantRelease_PollutantReleaseID]);
	Altova.Db.DbTreeOperations.SetValue(new_dbo_MethodUsed_PollutantRelease_PollutantReleaseID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_MethodUsed_PollutantRelease_altova_PollutantReleaseID], Altova.Db.DbTreeOperations.FindAttribute(tgt_dbo_PollutantRelease_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantRelease_altova_PollutantReleaseID]));
	bool bRowsAffected = false;
	bool bProcessChildren = true;
	bool bDeleteRow = false;
...
{
	// Create "MethodUsed"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_MethodUsed_PollutantRelease_PollutantReleaseID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_MethodUsed_PollutantRelease_altova_MethodUsed], Altova.CoreTypes.CastToString(m_var691_MethodTypeCode_string));
}
...
public void addMethodDesignation(XmlNode src_Designation, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_MethodUsed_PollutantRelease_PollutantReleaseID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_MethodUsed_PollutantRelease_PollutantReleaseID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_MethodUsed_PollutantRelease_altova_MethodDesignation], Altova.CoreTypes.CastToString(m_var695_Designation_string));
}
...
public void adddbo_PollutantTransfer_FacilityReportID(XmlNode src_PollutantTransfer, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.RecordBuffer new_dbo_PollutantTransfer_FacilityReportID = 
		Altova.Db.DbTreeOperations.AddElement(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_dbo_PollutantTransfer_FacilityReportID]);
	Altova.Db.DbTreeOperations.SetValue(new_dbo_PollutantTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantTransfer_altova_FacilityReportID], Altova.Db.DbTreeOperations.FindAttribute(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_FacilityReportID]));
	bool bRowsAffected = false;
	bool bProcessChildren = true;
	bool bDeleteRow = false;
...
{
	// Create "PollutantCode"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_PollutantTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantTransfer_altova_PollutantCode], Altova.CoreTypes.CastToString(m_var701_PollutantCode_string));
}
...
{
	// Create "MethodBasisCode"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_PollutantTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantTransfer_altova_MethodBasisCode], Altova.CoreTypes.CastToString(m_var705_MethodBasisCode_string));
}
...
{
	// Create "ConfidentialIndicator"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_PollutantTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantTransfer_altova_ConfidentialIndicator], Altova.CoreTypes.CastToBool(m_var709_ConfidentialIndicator_boolean));
}
...
{
	// Create "ConfidentialCode"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_PollutantTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantTransfer_altova_ConfidentialCode], Altova.CoreTypes.CastToString(m_var713_ConfidentialCode_string));
}
...
{
	// Create "RemarkText"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_PollutantTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantTransfer_altova_RemarkText], Altova.CoreTypes.CastToString(m_var717_RemarkText_string));
}
...
{
	// Create "Quantity"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_PollutantTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantTransfer_altova_Quantity], Altova.CoreTypes.CastToDouble(m_var721_Quantity_decimal_double));
}
...
{
	// Create "QuantityUnitCode"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_PollutantTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantTransfer_altova_QuantityUnitCode], Altova.CoreTypes.CastToString(m_var728_unitCode_string));
}
...
public void adddbo_MethodUsed_PollutantTransfer_PollutantTransferID(XmlNode src_MethodUsed, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_PollutantTransfer_FacilityReportID)
{
	...
	Altova.Db.DbTreeOperations.RecordBuffer new_dbo_MethodUsed_PollutantTransfer_PollutantTransferID = 
		Altova.Db.DbTreeOperations.AddElement(tgt_dbo_PollutantTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantTransfer_altova_dbo_MethodUsed_PollutantTransfer_PollutantTransferID]);
	Altova.Db.DbTreeOperations.SetValue(new_dbo_MethodUsed_PollutantTransfer_PollutantTransferID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_MethodUsed_PollutantTransfer_altova_PollutantTransferID], Altova.Db.DbTreeOperations.FindAttribute(tgt_dbo_PollutantTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_PollutantTransfer_altova_PollutantTransferID]));
	bool bRowsAffected = false;
	bool bProcessChildren = true;
	bool bDeleteRow = false;
...
{
	// Create "MethodUsed"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_MethodUsed_PollutantTransfer_PollutantTransferID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_MethodUsed_PollutantTransfer_altova_MethodUsed], Altova.CoreTypes.CastToString(m_var734_MethodTypeCode_string));
}
...
{
	// Create "MethodDesignation"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_MethodUsed_PollutantTransfer_PollutantTransferID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_MethodUsed_PollutantTransfer_altova_MethodDesignation], Altova.CoreTypes.CastToString(m_var738_Designation_string));
}
...
public void adddbo_WasteTransfer_FacilityReportID(XmlNode src_WasteTransfer, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID)
{
	...
	Altova.Db.DbTreeOperations.RecordBuffer new_dbo_WasteTransfer_FacilityReportID = 
		Altova.Db.DbTreeOperations.AddElement(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_dbo_WasteTransfer_FacilityReportID]);
	Altova.Db.DbTreeOperations.SetValue(new_dbo_WasteTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_WasteTransfer_altova_FacilityReportID], Altova.Db.DbTreeOperations.FindAttribute(tgt_dbo_FacilityReport_PollutantReleaseAndTransferReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_FacilityReport_altova_FacilityReportID]));
	bool bRowsAffected = false;
	bool bProcessChildren = true;
	bool bDeleteRow = false;
...
public void addWasteTypeCode(XmlNode src_WasteTypeCode, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_WasteTransfer_FacilityReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_WasteTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_WasteTransfer_altova_WasteTypeCode], Altova.CoreTypes.CastToString(m_var744_WasteTypeCode_string));
}
...
public void addWasteTreatmentCode(XmlNode src_WasteTreatmentCode, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_WasteTransfer_FacilityReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_WasteTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_WasteTransfer_altova_WasteTreatmentCode], Altova.CoreTypes.CastToString(m_var748_WasteTreatmentCode_string));
}
...
{
	// Create "MethodBasisCode"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_WasteTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_WasteTransfer_altova_MethodBasisCode], Altova.CoreTypes.CastToString(m_var752_MethodBasisCode_string));
}
...
{
	// Create "ConfidentialIndicator"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_WasteTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_WasteTransfer_altova_ConfidentialIndicator], Altova.CoreTypes.CastToBool(m_var756_ConfidentialIndicator_boolean));
}
...
{
	// Create "ConfidentialCode"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_WasteTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_WasteTransfer_altova_ConfidentialCode], Altova.CoreTypes.CastToString(m_var760_ConfidentialCode_string));
}
...
{
	// Create "RemarkText"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_WasteTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_WasteTransfer_altova_RemarkText], Altova.CoreTypes.CastToString(m_var764_RemarkText_string));
}
...
{
	// Create "Quantity"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_WasteTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_WasteTransfer_altova_Quantity], Altova.CoreTypes.CastToDouble(m_var768_Quantity_decimal_double));
}
...
{
	// Create "QuantityUnitCode"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_WasteTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_WasteTransfer_altova_QuantityUnitCode], Altova.CoreTypes.CastToString(m_var775_unitCode_string));
}
...
public void addWasteHandlerPartyName(XmlNode src_Name, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_WasteTransfer_FacilityReportID)
{
	...
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_WasteTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_WasteTransfer_altova_WasteHandlerPartyName], Altova.CoreTypes.CastToString(m_var781_Name_string));
}
...
public void adddbo_Address_WasteSite_WasteTransferID(XmlNode src_SiteAddress, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_WasteTransfer_FacilityReportID)
{
	...
	Altova.Db.DbTreeOperations.RecordBuffer new_dbo_Address_WasteSite_WasteTransferID = 
		Altova.Db.DbTreeOperations.AddElement(tgt_dbo_WasteTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_WasteTransfer_altova_dbo_Address_WasteSite_WasteTransferID]);
	Altova.Db.DbTreeOperations.SetValue(new_dbo_Address_WasteSite_WasteTransferID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_WasteSite_altova_WasteTransferID], Altova.Db.DbTreeOperations.FindAttribute(tgt_dbo_WasteTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_WasteTransfer_altova_WasteTransferID]));
	bool bRowsAffected = false;
	bool bProcessChildren = true;
	bool bDeleteRow = false;
...
{
	// Create "StreetName"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_Address_WasteSite_WasteTransferID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_WasteSite_altova_StreetName], Altova.CoreTypes.CastToString(m_var789_StreetName_string));
}
...
{
	// Create "BuildingNumber"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_Address_WasteSite_WasteTransferID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_WasteSite_altova_BuildingNumber], Altova.CoreTypes.CastToString(m_var793_BuildingNumber_string));
}
...
{
	// Create "CityName"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_Address_WasteSite_WasteTransferID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_WasteSite_altova_CityName], Altova.CoreTypes.CastToString(m_var797_CityName_string));
}
...
{
	// Create "PostcodeCode"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_Address_WasteSite_WasteTransferID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_WasteSite_altova_PostcodeCode], Altova.CoreTypes.CastToString(m_var801_PostcodeCode_string));
}
...
{
	// Create "CountryID"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_Address_WasteSite_WasteTransferID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_WasteSite_altova_CountryID], Altova.CoreTypes.CastToString(m_var805_CountryID_string));
}
...
public void adddbo_Address_Waste_WasteTransferID(XmlNode src_Address, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_WasteTransfer_FacilityReportID)
{
	...
	Altova.Db.DbTreeOperations.RecordBuffer new_dbo_Address_Waste_WasteTransferID = 
		Altova.Db.DbTreeOperations.AddElement(tgt_dbo_WasteTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_WasteTransfer_altova_dbo_Address_Waste_WasteTransferID]);
	Altova.Db.DbTreeOperations.SetValue(new_dbo_Address_Waste_WasteTransferID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_Waste_altova_WasteTransferID], Altova.Db.DbTreeOperations.FindAttribute(tgt_dbo_WasteTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_WasteTransfer_altova_WasteTransferID]));
	bool bRowsAffected = false;
	bool bProcessChildren = true;
	bool bDeleteRow = false;
...
{
	// Create "StreetName"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_Address_Waste_WasteTransferID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_Waste_altova_StreetName], Altova.CoreTypes.CastToString(m_var813_StreetName_string));
}
...
{
	// Create "BuildingNumber"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_Address_Waste_WasteTransferID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_Waste_altova_BuildingNumber], Altova.CoreTypes.CastToString(m_var817_BuildingNumber_string));
}
...
{
	// Create "CityName"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_Address_Waste_WasteTransferID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_Waste_altova_CityName], Altova.CoreTypes.CastToString(m_var821_CityName_string));
}
...
{
	// Create "PostcodeCode"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_Address_Waste_WasteTransferID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_Waste_altova_PostcodeCode], Altova.CoreTypes.CastToString(m_var825_PostcodeCode_string));
}
...
{
	// Create "CountryID"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_Address_Waste_WasteTransferID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_Address_Waste_altova_CountryID], Altova.CoreTypes.CastToString(m_var829_CountryID_string));
}
...
public void adddbo_MethodUsed_WasteTransfer_WasteTransferID(XmlNode src_MethodUsed, Altova.Db.DbTreeOperations.RecordBuffer tgt_dbo_WasteTransfer_FacilityReportID)
{
	...
	Altova.Db.DbTreeOperations.RecordBuffer new_dbo_MethodUsed_WasteTransfer_WasteTransferID = 
		Altova.Db.DbTreeOperations.AddElement(tgt_dbo_WasteTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_WasteTransfer_altova_dbo_MethodUsed_WasteTransfer_WasteTransferID]);
	Altova.Db.DbTreeOperations.SetValue(new_dbo_MethodUsed_WasteTransfer_WasteTransferID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_MethodUsed_WasteTransfer_altova_WasteTransferID], Altova.Db.DbTreeOperations.FindAttribute(tgt_dbo_WasteTransfer_FacilityReportID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_WasteTransfer_altova_WasteTransferID]));
	bool bRowsAffected = false;
	bool bProcessChildren = true;
	bool bDeleteRow = false;
...
{
	// Create "MethodUsed"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_MethodUsed_WasteTransfer_WasteTransferID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_MethodUsed_WasteTransfer_altova_MethodUsed], Altova.CoreTypes.CastToString(m_var835_MethodTypeCode_string));
}
...
{
	// Create "MethodDesignation"
	Altova.Db.DbTreeOperations.SetValue(tgt_dbo_MethodUsed_WasteTransfer_WasteTransferID, EPRTRxml1_TypeInfo.binder.Members[EPRTRxml1_TypeInfo._altova_mi_dbo_altova_MethodUsed_WasteTransfer_altova_MethodDesignation], Altova.CoreTypes.CastToString(m_var839_Designation_string));
}
