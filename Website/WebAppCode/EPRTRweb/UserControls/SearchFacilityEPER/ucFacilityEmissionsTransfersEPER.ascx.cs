...
public partial class ucFacilityEmissionsTransfersEPER : System.Web.UI.UserControl
{
    ...
    protected void OnItemCommand(object sender, ListViewCommandEventArgs e)
    {
        ...
        if (rowindex >= 0 && rowindex < listView.Items.Count)
        {
            ...
            if (command.Equals("toggletimeseries"))
            {
                ...
                ucFacilityPollutantTransfersTrendSheetEPER timeseries = (ucFacilityPollutantTransfersTrendSheetEPER)listView.Items[rowindex].FindControl("TransferTrendEPER");
    ...
    public void PopulateLists(int facilityReportID, int searchYear)
    {
        ...
        this.lvFacilityEmissionsTransfers.DataSource = methodPrep(Facility.GetPollutantTransfers(facilityReportID));
        this.lvFacilityEmissionsTransfers.DataBind();
    }
