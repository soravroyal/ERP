<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucFacilityPollutantReleasesTrendConfidentiality.ascx.cs" Inherits="ucFacilityPollutantReleasesTrendConfidentiality" %>
...
<div >
    ...
    <div runat="server" id="divConfidentialityInformation">
        <eprtr:CMStext ID="cmsConfidentialityExplanation" runat="server" ResourceType="Facility" ResourceKey="ConfidentialityExplanationTrendPR1"/>
        <br />
