...
<%@ Control Language="C#" AutoEventWireup="true" EnableViewState="true" CodeFile="ucAreaOverviewPollutantReleases.ascx.cs" Inherits="ucAreaOverviewPollutantReleases" %>
...
<eprtr:ucMediumSelector ID="ucMediumSelector"  OnItemSelected="OnMediumChanged" runat="server" />
...
<div class="clearBoth1">
    <asp:ListView ID="lvPollutantReleases" runat="server" OnItemCommand="rows_OnItemCommand" OnItemCreated="rows_OnItemCreated" OnItemDataBound="rows_OnItemDataBound" OnPreRender="lv_OnPreRender">
        ...
        <EmptyDataTemplate>
            <div class="noResult">
                <asp:Literal ID="litNoResult" Text="<%$ Resources:AreaOverview,NoPollutantReleasesFound %>" runat="server"></asp:Literal>
            </div>
        </EmptyDataTemplate>
