...
namespace MakeProperties
{
    class Program
    {
        ...
        {
            new DatabaseTable("LOV_AnnexIActivity", null, true),
		    new DatabaseTable("LOV_AreaGroup", null, true), 
		    new DatabaseTable("LOV_Confidentiality", null, true),
		    new DatabaseTable("LOV_CoordinateSystem", null, true),
		    new DatabaseTable("LOV_Country", null, true),
		    // TODO: new DatabaseTable("LOV_CountryAreaGroup", ??),
		    new DatabaseTable("LOV_Medium", null, true),
		    new DatabaseTable("LOV_MethodBasis", null, true),
		    new DatabaseTable("LOV_MethodType", null, true),
		    new DatabaseTable("LOV_NACEActivity", null, true),
		    new DatabaseTable("LOV_NUTSRegion", null, true),
		    new DatabaseTable("LOV_Pollutant", null, true),
		    // TODO: new DatabaseTable("LOV_PollutantThreshold", ??),
		    new DatabaseTable("LOV_RiverBasinDistrict", null, true),
		    new DatabaseTable("LOV_Status", null, true),
		    new DatabaseTable("LOV_Unit", null, true),
		    // TODO: new DatabaseTable("LOV_WasteThreshold", ??),
		    new DatabaseTable("LOV_WasteTreatment", null, true),
		    new DatabaseTable("LOV_WasteType", null, true),
		    ...
		    new DatabaseTable("RDF_PollutantReleaseAndTransferReport"),
