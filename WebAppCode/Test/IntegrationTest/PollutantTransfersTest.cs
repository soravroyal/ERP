...
{
	/// <summary>
	///This is a test class for PollutantTransfersTest and is intended
	///to contain all PollutantTransfersTest Unit Tests
	///</summary>
	[TestClass()]
	public class PollutantTransfersTest
	{
