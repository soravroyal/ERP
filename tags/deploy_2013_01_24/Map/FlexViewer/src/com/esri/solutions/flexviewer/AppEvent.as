	...
	public class AppEvent extends Event
	{
        ...
        */
        ...
        public static const LAYER_LOADED:String           = "layerLoaded";
         ...
         /**
         * This event type indicates print caption is being set.
         */
        public static const SET_PRINT_DETAILS 			= "setPrintDetails";
        ...
        public static const WIDGET_MENU_CLICKED:String  = "widgetMenuClicked";
         ...
         /**
         * This event type is used by the application to indicate all widgets that should be
         * preloaded have been loaded.
         * 
         */
        public static const WIDGETS_PRELOADED:String  = "widgetsPreloaded";
		...
		/**
        * event added to listen for a layer being turn off or on in the map
        * event for when a layers visibility has changed
        */
        public static const LAYER_VISIBILITY_CHANGED:String = "layerVisibilityChanged";
		//<----------Legend Work
        /**
        * event added by me for listening is the maps extent has changed
        * event for when the map extent has changed
        */
        public static const MAP_EXTENT_CHANGED:String = "mapExtentChanged";
        /**
        * event added changing static legend
        */
        public static const UPDATE_STATIC_LEGEND:String = "updateStaticLegend";
//<----------End Legend Work  
