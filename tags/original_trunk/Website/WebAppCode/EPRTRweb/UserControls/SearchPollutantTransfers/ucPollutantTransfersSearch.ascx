<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucPollutantTransfersSearch.ascx.cs" Inherits="ucPollutantTransfersSearch" %>
...
<asp:UpdatePanel ID="upPollutantTransfers"  runat="server">
