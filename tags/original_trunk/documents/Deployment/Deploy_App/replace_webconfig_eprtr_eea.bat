cscript replace.vbs "C:\E-PRTR_Ori\EEA\EPRTRpublic\EPRTRweb\web.config" "SDKCGA6302.rdg.bane.dk" "tetrasql"
cscript replace.vbs "C:\E-PRTR_Ori\EEA\EPRTRreview\EPRTRweb\web.config" "SDKCGA6302.rdg.bane.dk" "tetrasql"
