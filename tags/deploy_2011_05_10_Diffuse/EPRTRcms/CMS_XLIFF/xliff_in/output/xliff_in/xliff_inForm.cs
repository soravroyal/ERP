...
{
	/// <summary>
	/// Summary description for xliff_inForm.
	/// </summary>
	public class xliff_inForm : System.Windows.Forms.Form, Altova.TraceTarget
	{
		// general
		...
		public xliff_inForm()
		{
			...
			textBoxSource0.Text = "C:/EIONET/CMS_XLIFF/xliff_in/testatkins_utf8.xlf";
			textBoxTarget0.Text = "Provider=SQLOLEDB.1; Data Source=sdkcga6306; User ID=gis;Password=tmggis;Initial Catalog=EPRTRcms;Persist Security Info=true;Auto Translate=false;Tag with column collation=false;Use Encryption for Data=false;Mars_Connection=no;";
		...
		{
			xliff_inForm form = new xliff_inForm();
			form.ShowDialog();
		}
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(xliff_inForm));
			...
			this.labelSource0.Text = "Source of C:/EIONET/CMS_XLIFF/xliff_in/xliff-core-1.2-transitional.xsd:";
			// 
			// textBoxSource0
			// 
			...
			this.labelTarget0.Text = "Connection-string of EPRTRcms:";
			// 
			// textBoxTarget0
			// 
