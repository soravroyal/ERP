<%@ Control Language="C#" AutoEventWireup="false" CodeFile="ucStackColumn.ascx.cs" Inherits="ucStackColumn" %>
...
<div id="tschart" style="position:relative; left:-15px;">
  ...
  <asp:CHART id="stackcolumn" ImageStorageMode="UseImageLocation" BackColor="Transparent"  ImageLocation="~/Temp/stackcolumntmp_#SEQ(1000,5)" runat="server" AntiAliasing="Graphics" TextAntiAliasingQuality="High">
    <%-- No norder --%>
