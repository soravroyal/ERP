...
/// Delegate prop
/// </summary>
public delegate void YearSelectedEventHandler(object sender, YearSelectedEventArgs e);
public class YearSelectedEventArgs : EventArgs
{
    public YearSelectedEventArgs() { }
}	

/// <summary>
/// Compare years component
/// </summary>
public partial class ucYearCompare : System.Web.UI.UserControl
{
    
    private YearFilter Filter { get; set; }

    public event YearSelectedEventHandler ItemSelected;
    ...
    {
        // get reporting years
        List<int> years = ListOfValues.ReportYears(includeEper).ToList();
