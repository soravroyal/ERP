<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucTsPollutantReleasesConfidentiality.ascx.cs" Inherits="ucTsPollutantReleasesConfidentiality" %>
...
<eprtr:ucMediumSelector ID="ucMediumSelector"  OnItemSelected="OnMediumSelected" runat="server" />
...
<div class="clearBoth">
    ...
    <div runat="server" id="divConfidentialityInformation">
        <br />
        <eprtr:CMStext ID="cmsConfidentialityExplanation" runat="server" ResourceType="Timeseries" ResourceKey="ConfidentialityExplanationPR1"/>
        <br />
