...
({
  display: {
    ...
    popupRequirement: "הערה: הישות צריכה להיות בתוך שכבת ישויות או חלק משירות מפה הכולל תצוגת חלונות קופצים.",
  ...
  errors: {
    InvalidConfiguration: {
      code: 17056601,
      name: 'שגיאה בקביעת תצורה לא תקינה',
      message: 'קביעת תצורה לא תקינה.'
    },
    MissingConstructorParameters: {
      code: 17056602,
      name: 'שגיאה במחסור בפרמטר Constructor',
    ...
    SOEMultiPartGeometriesNotSupported: {
      code: 17056605,
      name: 'שגיאה בגיאומטריות מרובות חלקים לא נתמכות',
