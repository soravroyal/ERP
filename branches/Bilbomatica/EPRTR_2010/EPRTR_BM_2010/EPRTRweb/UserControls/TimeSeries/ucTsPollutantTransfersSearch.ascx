<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucTsPollutantTransfersSearch.ascx.cs" Inherits="ucTsPollutantTransfersSearch" %>
...
<asp:UpdatePanel ID="upTsPollutantTransfers"  runat="server">
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="plPollutantOptions" GroupingText="<%$Resources:Common,PollutantTransfers%>" CssClass="searchOption_pollutant" runat="server">
