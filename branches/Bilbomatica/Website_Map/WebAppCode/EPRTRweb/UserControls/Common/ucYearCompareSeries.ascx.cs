...
/// Delegate prop
/// </summary>
public delegate void YearSelectedEventHandlerSeries(object sender, YearSelectedEventArgsSeries e);
public class YearSelectedEventArgsSeries : EventArgs
{
    public YearSelectedEventArgsSeries() { }
}	

/// <summary>
/// Compare years component
/// </summary>
public partial class ucYearCompareSeries : System.Web.UI.UserControl
{
    
    private YearFilter Filter { get; set; }

    public event YearSelectedEventHandlerSeries ItemSelected;
