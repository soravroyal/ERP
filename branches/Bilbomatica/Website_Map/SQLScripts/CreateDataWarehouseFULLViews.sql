------------------------------------------------------------------------------
--	This script creates export views for all actual data in the master database 
--
--	this includes:
...
if object_id('FULL_POLLUTANTRELEASEANDTRANSFERREPORT')is not null DROP view FULL_POLLUTANTRELEASEANDTRANSFERREPORT
go
CREATE VIEW FULL_POLLUTANTRELEASEANDTRANSFERREPORT(
...
--select * from FULL_POLLUTANTRELEASEANDTRANSFERREPORT

------------------------------------------------------------------------------
--		create View for FACILITYREPORT
------------------------------------------------------------------------------

if object_id('FULL_FACILITYREPORT')is not null DROP view FULL_FACILITYREPORT
go
CREATE VIEW FULL_FACILITYREPORT(
    FacilityReportID,
    PollutantReleaseAndTransferReportID,
    FacilityID,
    NationalID,
    ...
    MainEconomicActivityNameSource,   
...
--select * from FULL_FACILITYREPORT order by city
...
if object_id('FULL_ACTIVITY')is not null DROP view FULL_ACTIVITY
go
CREATE VIEW FULL_ACTIVITY(
    ActivityID,
    FacilityReportID,
    FacilityReportName,
    AnnexIActivityCode,
...
if object_id('FULL_POLLUTANTRELEASE')is not null DROP view FULL_POLLUTANTRELEASE
go
CREATE VIEW dbo.FULL_POLLUTANTRELEASE(
    PollutantReleaseID,
    FacilityReportID,
    ReleaseMediumCode,
    ReleaseMediumName,
...
--select * from FULL_POLLUTANTRELEASE
...
if object_id('FULL_POLLUTANTRELEASEMETHODUSED')is not null DROP view FULL_POLLUTANTRELEASEMETHODUSED
go
CREATE VIEW dbo.FULL_POLLUTANTRELEASEMETHODUSED(
...
--select * from FULL_POLLUTANTRELEASEMETHODUSED
...
if object_id('FULL_POLLUTANTTRANSFER')is not null DROP view FULL_POLLUTANTTRANSFER
go
CREATE VIEW dbo.FULL_POLLUTANTTRANSFER(
    PollutantTransferID,
    FacilityReportID,
	PollutantCode,
    PollutantName,
...
--select * from FULL_POLLUTANTTRANSFER
...
if object_id('FULL_POLLUTANTTRANSFERMETHODUSED')is not null DROP view FULL_POLLUTANTTRANSFERMETHODUSED
go
CREATE VIEW FULL_POLLUTANTTRANSFERMETHODUSED(
...
--select * from FULL_POLLUTANTTRANSFERMETHODUSED
...
if object_id('FULL_WASTETRANSFER')is not null DROP view FULL_WASTETRANSFER
go
CREATE VIEW FULL_WASTETRANSFER(
    WasteTransferID,
    FacilityReportID,
    WasteTypeCode,
    WasteTypeName,
...
--select * from FULL_WASTETRANSFER order by ConfidentialIndicator
...
if object_id('FULL_WASTETRANSFERMETHODUSED')is not null DROP view FULL_WASTETRANSFERMETHODUSED
go
CREATE VIEW FULL_WASTETRANSFERMETHODUSED(
...
--select * from FULL_WASTETRANSFERMETHODUSED
...
if object_id('FULL_EPER2EPRTR_NACEACTIVITY')is not null DROP view FULL_EPER2EPRTR_NACEACTIVITY
go
CREATE VIEW FULL_EPER2EPRTR_NACEACTIVITY
AS
SELECT 
	Name as EPER_Name,
...
where EndYear = 2004
go
--select * from FULL_EPER2EPRTR_NACEACTIVITY
...
if object_id('FULL_EPER2EPRTR_ANNEXIACTIVITY')is not null DROP view FULL_EPER2EPRTR_ANNEXIACTIVITY
go

CREATE VIEW FULL_EPER2EPRTR_ANNEXIACTIVITY
AS
select 
...
--select * from FULL_EPER2EPRTR_ANNEXIACTIVITY
