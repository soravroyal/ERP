...
---------------------------------------------------------------------
--	ticket #1221 corrected:
--	The waste transfer query gives a result but repeats each facility in the facility list.
---------------------------------------------------------------------
...
as 
	select
		...
		m.HasReportedRecovery,
		m.HasReportedDisposal,
		m.HasReportedUnspecified,
	...
	inner join (
		select distinct
			...
			case when w2.WasteTreatmentCode = 'D' then 1 else 0 end as HasReportedDisposal,
			case when w3.WasteTreatmentCode = 'R' then 1 else 0 end as HasReportedRecovery,
			case when w4.WasteTreatmentCode = 'U' then 1 else 0 end as HasReportedUnspecified
		from 
			WEB_FACILITYSEARCH_WASTETRANSFER w
		left outer join 
			WEB_FACILITYSEARCH_WASTETRANSFER w2
		on	w.FacilityReportID = w2.FacilityReportID
		and w2.WasteTreatmentCode = 'D' 
		and w2.WasteTypeCode = 'NON-HW'
		left outer join 
			WEB_FACILITYSEARCH_WASTETRANSFER w3
		on	w.FacilityReportID = w3.FacilityReportID
		and w3.WasteTreatmentCode = 'R' 
		and w3.WasteTypeCode = 'NON-HW'
		left outer join (
			select
				FacilityReportID,
				'U' as WasteTreatmentCode
			from
				WEB_FACILITYSEARCH_WASTETRANSFER
			where isnull (WasteTreatmentCode,'U') = 'U'
			and WasteTypeCode = 'NON-HW'
			)w4	
		on	w.FacilityReportID = w4.FacilityReportID		
		where w.WasteTypeCode = 'NON-HW'
		)m
...
union
	...
	inner join (
		...
		on	w.FacilityReportID = w2.FacilityReportID
		and w2.WasteTreatmentCode = 'D' 
		and w2.WasteTypeCode = 'HWIC'
		left outer join 
			WEB_FACILITYSEARCH_WASTETRANSFER w3
		on	w.FacilityReportID = w3.FacilityReportID
		and w3.WasteTreatmentCode = 'R' 
		and w3.WasteTypeCode = 'HWIC'
		left outer join (
			select
				FacilityReportID,
				'U' as WasteTreatmentCode
			from
				WEB_FACILITYSEARCH_WASTETRANSFER
			where isnull (WasteTreatmentCode,'U') = 'U'
			and WasteTypeCode = 'HWIC'
			)w4	
		on	w.FacilityReportID = w4.FacilityReportID		
		where w.WasteTypeCode = 'HWIC'
	)m
	on w.FacilityReportID = m.FacilityReportID
	where ( 
...
union
	...
	inner join (
		...
		on	w.FacilityReportID = w2.FacilityReportID
		and w2.WasteTreatmentCode = 'D' 
		and w2.WasteTypeCode = 'HWOC'
		left outer join 
			WEB_FACILITYSEARCH_WASTETRANSFER w3
		on	w.FacilityReportID = w3.FacilityReportID
		and w3.WasteTreatmentCode = 'R' 
		and w3.WasteTypeCode = 'HWOC'
		left outer join (
			select
				FacilityReportID,
				'U' as WasteTreatmentCode
			from
				WEB_FACILITYSEARCH_WASTETRANSFER
			where isnull (WasteTreatmentCode,'U') = 'U'
			and WasteTypeCode = 'HWOC'
			)w4	
		on	w.FacilityReportID = w4.FacilityReportID		
		where w.WasteTypeCode = 'HWOC'
	)m
	on w.FacilityReportID = m.FacilityReportID
	where ( 
...
union
	...
	inner join (
		...
		on	w.FacilityReportID = w2.FacilityReportID
		and w2.WasteTreatmentCode = 'D' 
		and w2.WasteTypeCode like 'HW%'
		left outer join 
			WEB_FACILITYSEARCH_WASTETRANSFER w3
		on	w.FacilityReportID = w3.FacilityReportID
		and w3.WasteTreatmentCode = 'R' 
		and w3.WasteTypeCode like 'HW%'
		left outer join (
			select
				FacilityReportID,
				'U' as WasteTreatmentCode
			from
				WEB_FACILITYSEARCH_WASTETRANSFER
			where isnull (WasteTreatmentCode,'U') = 'U'
			and WasteTypeCode like 'HW%'
			)w4	
		on	w.FacilityReportID = w4.FacilityReportID		
		where w.WasteTypeCode like 'HW%'
	)m
	on w.FacilityReportID = m.FacilityReportID
	where ( 
		ConfidentialIndicatorHWIC = 1 
