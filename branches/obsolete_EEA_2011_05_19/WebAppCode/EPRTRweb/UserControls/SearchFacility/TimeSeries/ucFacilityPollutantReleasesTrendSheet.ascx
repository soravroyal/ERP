<%@ Control Language="C#" AutoEventWireup="true" EnableViewState="true" CodeFile="ucFacilityPollutantReleasesTrendSheet.ascx.cs" Inherits="ucFacilityPollutantReleasesTrendSheet" %>
...
<%@ Register Src="~/UserControls/SearchFacility/TimeSeries/ucFacilityPollutantReleasesTrendConfidentiality.ascx" TagName="ucFacilityPollutantReleasesTrendConfidentiality" TagPrefix="eprtr" %>
...
<div class="look_sheet_level2">
    ...
    <div class="layout_sheet_content">
      ...
      <eprtr:ucFacilityPollutantReleasesTrendConfidentiality ID = "ucContentConfidentiality" runat="server" visible="false"/>
    </div>
