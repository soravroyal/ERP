<%@ Control Language="C#" AutoEventWireup="true" EnableViewState="true" CodeFile="ucFacilityPollutantTransfersTrendSheet.ascx.cs" Inherits="ucFacilityPollutantTransfersTrendSheet" %>
...
<%@ Register Src="~/UserControls/SearchFacility/TimeSeries/ucFacilityPollutantTransfersTrendConfidentiality.ascx" TagName="ucFacilityPollutantTransfersTrendConfidentiality" TagPrefix="eprtr" %>
    ...
    <div class="layout_sheet_content">
      ...
      <table id="compareTable" visible="true" cellspacing="15" runat="server">
        ...
        <tr>
          <%-- Compare year --%>
          <td>
            <eprtr:ucYearCompare ID="ucYearCompare" Visible="false" runat="server" />
      ...
      <eprtr:ucFacilityPollutantTransfersTrendConfidentiality ID="ucContentConfidentiality" Visible="false" runat="server" />
    </div>
