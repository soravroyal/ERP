...
public partial class ucFacilityPollutantTransfersTrendConfidentiality : System.Web.UI.UserControl
{
    private const string POLLUTANTCODE = "transfertrendConfPollutantcode";
    private const string PARENTCODE = "transfertrendConfParentCode";
