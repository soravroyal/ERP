<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucAdvancedActivitySearchOption.ascx.cs" Inherits="ucAdvancedActivitySearchOption" %>
...
<asp:UpdatePanel ID="upActivity" runat="server">
    ...
    <asp:Panel ID="plActivityOptions" GroupingText="<%$Resources:Common,Activity%>" runat="server" CssClass="searchOption_activity" >
        ...
        <%--expand label--%>
        <asp:Label ID="lblActivity2" Text="<%$Resources:Common,CurrentlyNotIncluded%>" runat="server" CssClass="cpeTextLabel2"></asp:Label>
