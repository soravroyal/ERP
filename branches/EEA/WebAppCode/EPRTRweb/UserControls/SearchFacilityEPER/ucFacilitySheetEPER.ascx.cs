...
public partial class ucFacilitySheetEPER : System.Web.UI.UserControl
{
    ...
    {
        Populate(facilityReportID, Sheets.FacilityDetails.Details.ToString());
    }


    /// <summary>
    /// Present content for the facility report given with the content chosen
    /// </summary>
    private void Populate(string facilityReportID, string content)
    {
