...
<div>
<asp:ListView ID="lvPollutantReleasesArea" runat="server" OnItemCommand="OnItemCommand" OnDataBinding="OnDataBinding">
         ...
         <table>
           <thead>
            <tr class="generalListStyle_headerRow">
              ...
              <th><div class="PRcolName"><asp:Label ID="lbReleasesPerCountry" Text="<%$ Resources:Pollutant,ReleasesPerCountry %>" runat="server"></asp:Label></div></th>
              ...
              <th><div id="divHeaderAir" class="PRcolAir" runat="server" ><asp:Label ID="lbAir" Text="<%$ Resources:Pollutant,Air %>" runat="server"></asp:Label></div></th>
              <th><div id="divHeaderWater" class="PRcolWater" runat="server"><asp:Label ID="lbWater" Text="<%$ Resources:Pollutant,Water %>" runat="server"></asp:Label></div></th>
              <th><div id="divHeaderSoil" class="PRcolSoil" runat="server"><asp:Label ID="lbSoil" Text="<%$ Resources:Pollutant,Soil %>" runat="server"></asp:Label></div></th>
            </tr>
           </thead>
           <tbody>
